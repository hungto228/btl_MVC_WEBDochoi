...
namespace Web_enti_mvc.Controllers
{
    public class SanPhamsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaSP,TenSP,Mota,SoLuong,HinhSP,DonGia,MaLoai")] SanPham sanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaSP,TenSP,Mota,SoLuong,HinhSP,DonGia,MaLoai")] SanPham sanPham)
        {
            if (ModelState.IsValid)
            {
